var hard = {
    ...
    "hamper": ["obstruct", "prevent the free movement of", "N: 侥丰前捞唱 狼汗 殿阑 淬绰 官备聪 "],
    "hap": ["chance", "luck"],
    ...
    "panache": ["flair", "manner of doing things without any difficulty (causing admiration)", "flamboyance", "bunch of feathers (on a helmet)", "Ex. with great panache", "CF. 儡 酒贰肺 玫阑 哗郴绰 钾揪"],
    ...
    "parry": ["ward off a blow", "deflect", "Ex. He parried the unwelcome question very skillfully", "N. CF. 阜绰促绰 俺充捞 酒丛"],
    ...
    "precipitant": ["something that causes a substance in a chemical solution to separate out in solid form", "魔傈力", "OP. solvent"],
    ...
    "quaff": ["drink with zest", "drink with relish(zest", "hearty enjoyment)", "曹博曹博 付矫促", "CF. sip"],
    ...
    "quarry": ["dig into (to get stone)", "N: mine", "盲籍厘"],
    ...
    "squelch": ["produce a splashing sound (when stepping through mud)", "crush", "squash", "CF. 柳入阑 困俊辑 光阑 锭"],
    ...
    "tepid": ["lukewarm", "slightly warm", "固瘤辟茄", "half-hearted", "not eager", "Ex. tepid reaction to the new film", "Ex. tepid supporter"],
...
var barron = {
    ...
    "coy": ["shy (flirtatiously)", "showing a (pretended) lack of self-confidence", "modest", "coquettish", "CF. job offer甫 罐疽阑 锭"],
    "cozen": ["cheat", "hoodwink", "swindle"],
    ...
    "gale": ["windstorm", "gust of wind", "emotional outburst (laughters, tears)", "Ex. gale of laughter"],
    "gall": ["bitterness of feeling", "nerve", "effrontery", "淬馏(bile)", "CF. gall bladder"],
...
function renderRe(re) {
    return "<span class=\"hard word\" style=\"background-color:#d395fa;\">" + re + "</span>";
}

function renderTran(tran) {
    var innerHTML = "<span class=\"hard comment\" style=\"background-color:#aacff7;\">[ ";
