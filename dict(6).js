var hard = {
    ...
    "accolade": ["award of merit", "strong praise and approvals merit good quality deserving praise", "merits: aspect of character or behavior deserving approval or disapproval", "Ex. judge each plan on its own merits", "V: deserve", "earns demerit fault", "bad qualitys earn gain for the performance of service or labor", "gain (something that one deserves)", "deserve"],
    ...
    "conformity": ["harmony", "agreement with established rules or customs", "similarity", "Ex. behave in conformity with", "V. conform: be similar", "act in agreement", "comply", "Ex. conform to the rule", "CF. conformans ce"],
    "conformist ": ["person who uncritically conforms to the customs of a group", "OP. nonconformist: one who does not conform to accepted beliefs of norn ms"],
    ...
    "futile": ["seless", "hopeless", "ineffectual"],
    ...
    "hamper": ["obstruct", "prevent the free movement of", "N: ½Ä·áÇ°ÀÌ³ª ÀÇº¹ µîÀ» ´ã´Â ¹Ù±¸´Ï "],
    "hap": ["chance", "luck"],
    ...
    "medium": ["element that is a creature's natural environment", "nutrient setting in which microorganisms are cultivated", "appropriate occupation or means of expression", "channel of communication", "compromise", "middle position between extremes", "intervening substance through which something else is transmitted"],
    "medley": ["mixture"],
    ...
    "panache": ["flair", "manner of doing things without any difficulty (causing admiration)", "flamboyance", "bunch of feathers (on a helmet)", "Ex. with great panache", "CF. ÀÜ ¾Æ·¡·Î ÃµÀ» »©³»´Â ¼Ø¾¾"],
    ...
    "parry": ["ward off a blow", "deflect", "Ex. He parried the unwelcome question very skillfully", "N. CF. ¸·´Â´Ù´Â °³³äÀÌ ¾Æ´Ô"],
    ...
    "precipitant": ["something that causes a substance in a chemical solution to separate out in solid form", "Ä§ÀüÁ¦", "OP. solvent"],
    ...
    "quaff": ["drink with zest", "drink with relish(zest", "hearty enjoyment)", "²Ü²©²Ü²© ¸¶½Ã´Ù", "CF. sip"],
    ...
    "quarry": ["dig into (to get stone)", "N: mine", "Ã¤¼®Àå"],
    ...
    "squelch": ["produce a splashing sound (when stepping through mud)", "crush", "squash", "CF. ÁøÈëÀ» À§¿¡¼­ ¹âÀ» ¶§"],
    ...
    "scotch": ["stamp out(put an end to)", "thwart", "hinder", "Ex. scotch the rumor", "CF. cut", "CF. È°µ¿À» ÁÙÀÌ´Â ÀÇ¹Ì"],
    ...
    "teetotalism": ["practice of abstaining totally from alcoholic drinks", "N. teetotaler;", "ADJ. teetotal;"],
    ...
    "tepid": ["lukewarm", "slightly warm", "¹ÌÁö±ÙÇÑ", "half-hearted", "not eager", "Ex. tepid reaction to the new film", "Ex. tepid supporter"],
...
var barron = {
	...
	"aquiline": ["curved", "hooked", "of or like an eagle", "Ex. aquiline nose"],
	"arable": ["fit for growing crops", "Ex. arable land"],
	"arbiter": ["person with power to decide a matter in dispute", "judge who is in a position ot make influentialjudgments", "Ex. supreme arbiter of fashion in beachware"],
	"arbitrary": ["unreasonable or capricious", "random", "tyrannical", "Ex. arbitrary ruler"],
	"arbitrate": ["act as judge (at the request of both sides)"],
	"arboretum": ["place where different trees and shrubs are studied and exhibited"],
	"arboreal": ["of or living in trees"],
	...
	"benefit": ["advantage", "anything that brings help, advantage, or profit", " money provided by the government to the people", "fund-raising public entertainment", "Ex. unemployment benefit", "V: receive benefits", "be beneficial to", "give benefits"],
	...
	"confidence": ["self-assurance", "calm unworried feeling based on a strong belief in one's abilities", "strong belief in the ability of a person or plan", "trust or faith in a person or thing", "something confided", "secret", "Ex. confidence in your ability", "Ex. I'm telling you this in confidence", "Ex. exchange confidences about their boyfriends", "ADJ. confides nt"],
	...
	"coy": ["shy (flirtatiously)", "showing a (pretended) lack of self-confidence", "modest", "coquettish", "CF. job offer¸¦ ¹Þ¾ÒÀ» ¶§"],
	"cozen": ["cheat", "hoodwink", "swindle"],
	...
	"dearth": ["scarcity"],
	"d\'eb\^acle": ["sudden disastrous downfall or defeat", "complete disaster"],
	...
	"decipher": ["decode", "CF. indecipherable"],
	"declivity": ["downward slope"],
	"d\'ecollet\'e": ["(of a dress) having a low-cut neckline", "CF. d\'ecolletage: low neckline (on a dress)"],
	"decree": ["authoritative order", "edict", "judgment of a court of law", "V: order or judge by decree"],
	"decomposition": ["decay", "V. decompose: decay", "break and separate into simple parts"],
	"decorum": ["propriety", "orderliness and good taste in manners", "appropriateness of behavior or conduct"],
	"decorous": ["proper (in behavior, conduct, or appearance)"],
	...
	"decrepitude": ["state of collapse or weakness caused by illness or old age"],
	"decrepit": ["weak and in bad condition from old age or hard use", "Ex. decrepit old chair/man"],
	"n decry": ["express strong disapproval of", "condemn openly (something dangerous to the public)", "disparage", "Ex. decry the violence of modern films"],
	"deducible": ["derived by reasoning", "V. deduce: infer", "derive by reasoning"],
	"deface": ["mar", "disfigure"],
	...
	"degradation": ["humiliation", "debasement", "degeneration", "V. degrade: debase", "disgrace", "degenerate", "reduce (something) in worth", "demote (someone)", "reduce in rank"],
	"dishonor": ["disgrace", "N. ADJ. dishonorable"],
	"n dehydrate": ["remove water from", "dry out"],
	"deify": ["turn into a god", "make a god of", "idolize", "Ex. Kings were deified", "CF. deity"],
	"deign": ["condescend", "stoop"],
	...
	"figure": ["written symbols", "number", "amount represented in numbers", "outline or silhouette of a thing or human body", "person (well-known)", "impression", "diagram", "pattern", "group in a dance", "Ex. figure of speech", "V. calculate with numbers", "adorn with figures", "appear", "consider", "Ex. My name did not figure in the list."],
	"figurine": ["small ornamental statuette(very small statue)"],
	"filch": ["steal (things of small value)"],
	...
	"fodder": ["coarse food for cattle, horses, etc.", "feed for livestock", "CF. food"],
	"foible": ["small weakness of character", "slight fault", "CF. feeble"],
	"foil": ["contrast", "one that by contrast enhances the distinctive characteristics of another"],
	...
	"gale": ["windstorm", "gust of wind", "emotional outburst (laughters, tears)", "Ex. gale of laughter"],
	"gall": ["bitterness of feeling", "nerve", "effrontery", "´ãÁó(bile)", "CF. gall bladder"],
	...
	"juncture": ["crisis", "point in time", "joining point", "joint", "act of joining"],
	"junket": ["trip especially one taken for pleasure by an official at public expense"],
	"unta": ["group of persons joined in political intrigue", "cabal", "group of military officers ruling a country after seizing power (by force)"],
	"jurisprudence": ["science of law"],
	"jurisdiction": ["right and power to apply the law", "authority"],
	"juridical": ["of the law and its administration", "CF. judicial: of courts of law", "CF. judiciary"],
	"juxtapose": ["place side by side", "CF. next"],
	...
	"microcosm": ["small representative world", "world in miniature", "Ex. microcosm of English society"],
	"s miniature": ["small model", "small painting", "ADJ: small"],
	"migrant": ["changing its habitat", "wandering", "Ex. migrant birds/workers", "N: one that migrates"],
	"migratory": ["wandering", "V. migrate: move from one region and settle in another", "move periodically from one region to another"],
	"milieu": ["social environment", "means of expression", "Ex. feel out of one's milieu", "Ex. His proper milieu is watercolor."],
	"militant": ["combative", "bellicose", "N."],
	...
	"outstrip": ["outrun", "surpass", "outdo"],
	"outwit": ["outsmart", "defeat by behaving more cleverly"],
	"n ovation": ["enthusiastic applause"],
	"overbearing": ["bossy", "domineering and arrogant", "decisively important", "Ex. overbearing manner/importance", "V. overbear: dominate"],
	"overt": ["open to view", "public", "not secret", "CF. covert"],
	"overweening": ["arrogant", "presumptuous"],
	"overwrought": ["nervous or excited", "extremely agitated", "hysterical", "wrought-up", "CF. wrought: made or done"],
	...
	"pontifical": ["pertaining to a bishop or pope", "pompous or pretentious", "CF. pontiff: pope", "bishop"],
	"pore": ["study industriously", "ponder", "scrutinize", "Ex. pore over the book", "N."],
	"orous": ["full of pores", "like a sieve"],
	...
	"resolve": ["determination", "resolution", "firmness of purpose"],
	...
	"avantgarde": ["group of artists whose work is based on the newest ideas and methods", "CF. vanguard"],
	"vantage": ["position giving an advantage (such as a strategic point)", "CF. vantagepoint"],
	"apid": ["lacking liveliness", "dull and unimaginative", "insipid and flavorless", "Ex. vapid lecture"],
	"vaporize": ["turn into vapor (steam, gas, fog, etc.)"],
	"variegated": ["(esp. of a flower or leaf) many-colored"],
	"variegate": ["change the appearance of (by marking with different colors)"],
	"vassal": ["in feudalism, one who held land of a superior lord", "subordinate or dependent"],
...
function renderRe(re) {
    return "<span style=\"background-color:#d395fa;\">" + re + "</span>";
}

function renderTran(tran) {
    var innerHTML = "<span style=\"background-color:#aacff7;\">[ ";
...
function dict(isHard){
	var ps = document.getElementsByTagName("p");
	for (var i = 0; i !== ps.length; i++) {
		var res = ps[i].innerHTML.split(" ");
		var innerHTML = [];
		for (var j = 0; j !== res.length; j++) {
			...
			if (tran === undefined) {
			    innerHTML.push(res[j]);
			} else {
			    innerHTML.push(renderRe(res[j]));
			    innerHTML.push(renderTran(tran));
			}
		}
		ps[i].innerHTML = innerHTML.join(" ");
	}
}